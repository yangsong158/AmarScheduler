...
//		var elem;
	...
	initGroup:function(width,height){
	  ...
	  this.$group.on("mousedown",{inthis:this},function(e){//绑定RESIZE功能以及移动功能
		...
		var vX = null,vY = null;
		if(cursor!="move"){
			vX=(This.$areaData[id].left+This.$areaData[id].width)-X;
			vY=(This.$areaData[id].top+This.$areaData[id].height)-Y;
		}else{
			vX=X-This.$areaData[id].left;
			vY=Y-This.$areaData[id].top;
		}
		var isMove=false;
...
///////////以下为有关画线的方法
	...
	calcStartEnd:function(n1,n2){
		var X_1=null,Y_1=null,X_2=null,Y_2=null;
		//X判断：
