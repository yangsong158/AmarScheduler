...
<body>
	...
	<script type="text/javascript">
			       ...
			       columns: [ 
					...
					toolbar: 
						...
						items: [
			                ...
			                { text: '运行', click: runTaskFile, iconClass: 'icon_pc' },
			                { line: true }
			            ]
			        },
		...
		function openTaskDetailInTab(rowdata){
			if(rowdata){
				parent.tabsView.toggleTabItem(rowdata.fileName,rowdata.fileName,"TaskFileManage-detail.jsp?fileName="+rowdata.fileName,true);
			}
		}
